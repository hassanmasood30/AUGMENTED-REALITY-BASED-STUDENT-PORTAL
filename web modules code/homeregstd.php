                ...
                <div id="content">
                    ...
                    <form method="POST" action="registerstudent.php">
                            ...
                            <div class="form-group" style="width:50%">
                                <label for="Home Address">Student Id:</label>

                                <input type="text" class="form-control"  placeholder="Enter Student Id" name="ename"required>
                              </div><br>
                              <div class="form-group" style="width:50%">
                            <label for="pwd">First Name:</label>

                            <input type="text" class="form-control"  placeholder="Enter First Name" name="aname" required>
                            </div><br>

                            <div class="form-group" style="width:50%">
                              <label for="email">Last Name:</label>

                              <input type="text" class="form-control"  placeholder="Enter Last Name" name="bname"required>
                            </div><br>

                            <div class="form-group" style="width:50%">
                                <label for="mobilenum">Registration:</label>

                                <input type="text" class="form-control"  placeholder="Enter Registration No" name="cname"required>
                              </div><br>


                              <div class="form-group" style="width:50%">
                                <label for="CNIC Number">Section:</label>

                                <input type="text" class="form-control" placeholder="Enter Section (XXX-XX)" name="dname"required>
                              </div><br>
                            ...
                            <div class="form-group" style="width:50%">
                              ...
                              <input type="email" class="form-control" placeholder="Enter Email" name="fname"required>
                            </div><br>
