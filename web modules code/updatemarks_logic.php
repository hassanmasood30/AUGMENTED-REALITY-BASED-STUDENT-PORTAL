...
<body>
<a href="updatemarks.php"><button type="button" class="btn btn-dark">BACK TO ADMIN PAGE</button></a><BR><BR>
...
<div class="row align-items-center myBody "  style="height:AUTO;">
  ...
  <button type="submit" STYLE="MARGIN-LEFT:70%" class="btn btn-dark">UPDATE MARKS</button><br>
