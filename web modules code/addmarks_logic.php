...
<body>
<a href="addmarks.php"><button type="button" class="btn btn-dark">BACK TO ADMIN PAGE</button></a><BR><BR>
...
<div class="row align-items-center myBody "  style="height:AUTO;">
    ...
    <div class="col">
	  <h1 style="margin-left:40% ;color: BLACK">ADD MARKS</h1><br><br>
  ...
  <button type="submit" STYLE="MARGIN-LEFT:75%" class="btn btn-dark">ADD MARKS</button><br>
