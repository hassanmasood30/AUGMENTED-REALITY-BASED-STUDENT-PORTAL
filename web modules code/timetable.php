...
<a href="HOMEPAGE.php">Home</a>
                ...
                <div id="content">
                    ...
                    <div class="container" >
                    <form method="POST" action="timetable_insert.php">
                    
                    <div class="form-group" style="width:50%">
                              <label for="email">TIMETABLE ID:</label>

                              <input type="text" class="form-control"  placeholder="Enter Timetable Id" name="tid"required>
                            </div><br>
					...
					<div>
						<select class="form-control" id="select_catalog" name="section" required>
