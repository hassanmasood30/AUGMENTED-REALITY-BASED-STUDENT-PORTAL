...
<a href="HOMEPAGE.php">Home</a>
                    ...
                    <li>
                        ...
                        <li>
                            ...
                            <li>
                                ...
                                <li>
                                    <a href="updateattendance">Update Attendance</a>
                                </li>
                ...
                <div id="content">
                    ...
                    <h3>&nbsp;&nbsp;Update Timetable</h3><br>

                    <div class="container" >
                    <form method="POST" action="timetable_update.php">
                
                    <div class="form-group"  style="width:50%">
					<span class="label-input100">Section:</span>
					<div>
						<select class="form-control" id="select_catalog" onchange=" myFunction()" name="section" required>
							<option value="">Select Section</option>
                 <?php
                         $con = mysqli_connect("localhost","root","","mydb");
                         $sql = "SELECT DISTINCT timetableid,section from timetable";
                        ...
                        if(mysqli_num_rows($result) > 0)
                         ...
                         while ($row = mysqli_fetch_array($result))
                         {
                          ...
                          echo  "<option>" .$row['timetableid']." : " .$row['section']."</option>";
                ...
                ?>
                    ...
                    <div class="form-group" style="width:50%">
                              <label for="email">TIMETABLE ID:</label>

                              <input type="text" class="form-control"  id="SID" placeholder="Timetable ID" name="tid" required>
                            </div><br>
                            <div class="form-group" style="width:50%">
                              <label for="email">Day ID:</label>

                              <input type="text" class="form-control"  placeholder="Enter Day ID" name="Dayid"required>
                            </div><br>

                            <div class="form-group" style="width:50%">
                                <label for="mobilenum">Slot ID:</label>

                                <input type="text" class="form-control"  placeholder="Enter Slot ID" name="Slotid"required>
                              </div><br>


                              <div class="form-group" style="width:50%">
                                <label for="CNIC Number">Subject Name:</label>

                                <input type="text" class="form-control" placeholder="Enter Subject Name" name="Subject"required>
                              </div><br>


                              <div class="form-group" style="width:50%">
                                <label for="Home Address">Class Room:</label>

                                <input type="text" class="form-control"  placeholder="Enter Class Room" name="ClassRoom"required>
                              </div><br>
