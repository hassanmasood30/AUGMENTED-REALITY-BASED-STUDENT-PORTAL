...
<body>
<a href="addattendance.php"><button type="button" class="btn btn-dark">BACK TO ADMIN PAGE</button></a><BR><BR>
...
<div class="row align-items-center myBody "  style="height:AUTO;">
    ...
    <div class="col">
	  <h1 style="margin-left:35% ;color: BLACK">ADD ATTENDANCE</h1><br><br>
  ...
  <button type="submit" STYLE="MARGIN-LEFT:65%" class="btn btn-dark">ADD ATTENDANCE</button><br>
